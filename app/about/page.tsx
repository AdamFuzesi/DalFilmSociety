  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <main className="container mx-auto px-4 py-16">
        <h1 className="font-serif text-4xl md:text-5xl font-light tracking-wider text-center mb-16">About Us</h1>

        {/* First section */}
        <section className="flex flex-col md:flex-row items-center gap-8 md:gap-16 mb-24">
          <div className="md:w-1/2 space-y-4">
            ...
            <p className="text-lg leading-relaxed">
              No experience? No problem! Our society is open to anyone with an interest in filmmaking, storytelling, or
              film appreciation. Choose your interest, and we'll find the team for you.
            </p>
          </div>
        ...
        {/* Second section */}
        <section className="flex flex-col md:flex-row-reverse items-center gap-8 md:gap-16 mb-24">
          <div className="md:w-1/2 space-y-4">
          ...
          <div className="md:w-1/2 relative h-64 md:h-96 w-full rounded-lg overflow-hidden">
            <Image src="/aboutCamera.jpg?height=600&width=800" alt="Film Production" fill className="object-cover" />
          </div>
        </section>
        ...
        <section className="flex flex-col md:flex-row items-center gap-8 md:gap-16 mb-24">
          <div className="md:w-1/2 space-y-4">
            ...
            <p className="text-lg leading-relaxed">
              ...
              Whether you're interested in writing, directing, cinematography, acting, editing, or simply curious about
              filmmaking, we invite you to join us and bring your ideas to life!
            </p>
          </div>
          <div className="md:w-1/2 relative h-64 md:h-96 w-full rounded-lg overflow-hidden">
            <Image src="/premiereAbout.png?height=600&width=800" alt="Film Premiere" fill className="object-cover" />
          </div>
        </section>

        {/* Join us section */}
        <section className="text-center max-w-3xl mx-auto mb-16 py-8 border-t border-b border-white/20">
